...
import 'package:invoice/src/common/util/platform/keyboard_observer_vm.dart'
    // ignore: uri_does_not_exist
    if (dart.library.html) 'package:invoice/src/common/util/platform/keyboard_observer_js.dart';
