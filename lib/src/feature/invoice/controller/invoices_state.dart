...
final class InvoicesState$Processing extends InvoicesState {
  const InvoicesState$Processing({required super.data, super.message = 'Processing'});
}

/// Successful
final class InvoicesState$Successful extends InvoicesState {
  const InvoicesState$Successful({required super.data, super.message = 'Successful'});
}

/// Error
final class InvoicesState$Error extends InvoicesState {
  const InvoicesState$Error({required super.data, super.message = 'An error has occurred.'});
}
